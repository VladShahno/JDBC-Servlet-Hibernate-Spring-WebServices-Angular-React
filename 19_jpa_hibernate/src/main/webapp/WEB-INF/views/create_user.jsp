...
<div style="width: 70%; margin: 0 auto;">
    ...
    <form class="ajax-form" id="pwreset"
          action="${pageContext.request.contextPath}/new" method="post" style="display: flex;
        ...
        <div style="margin-top: 5px" id="emailError"><span>${emailError}</span>
        </div>
        ...
        <input type="date" name="birthday" id="user_birthday"
               class="form-control" required value="${user.birthday}"">
